...
const LeadStream = () => {
    ...
    const fetchLeadData = useCallback(async (silent = false) => {
        try {
            ...
            if (response.success) {
                ...
                console.log('✅ Activities loaded:', response.activities.length);
            ...
            if (response.success) {
                ...
                try {
                    ...
                    if (repliesResponse.success) {
                        console.log('✅ Loaded', repliesResponse.replies.length, 'replies for top-level parent', topLevelParentId);
    ...
    console.log('🎨 Render state - Loading:', loading, 'Lead:', !!lead); // ✅ KEEP: Helps debug render issues
